...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Isi formulir berikut untuk menambahkan produk piring keramik batik baru.</p>
        </div>
    </div>
    ...
    <div class="bg-white p-8 border border-batik-gold/20 shadow-sm">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Gambar Utama -->
                <div>
                    <label for="image" class="block text-sm font-semibold text-dark-brown mb-2">Gambar Produk <span class="text-red-500">*</span> (Max 2MB)</label>
            ...
            <div class="border-t border-gray-100 pt-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="url" name="booking_link" id="booking_link" required value="{{ old('booking_link') }}"
                            class="w-full px-4 py-2.5 border border-gray-300 text-sm focus:outline-none focus:ring-1 focus:ring-batik-gold"
